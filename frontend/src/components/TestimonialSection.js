  ...
  const testimonials = [
    {
      ...
      name: "Gowtham",
      rating: 5.0,
      text: "Star Motors exceeded my expectations with their exceptional customer service.",
    },
    {
    ...
    },
    {
      ...
      name: "Karthick",
      rating: 5.0,
      text: "Star Motors is selling very low price than other second-hand bike sellers.",
    },
  ];
